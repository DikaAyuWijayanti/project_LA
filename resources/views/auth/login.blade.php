            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mt-3">
                    <button class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" type="submit"><strong>SIGN IN</strong></button>
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Belum punya <strong>Akun</strong>? <a href="/register" class="text-primary"><strong>Buat Akun</strong></a>
                  </div>
                </form>
              </div>
            </div>
